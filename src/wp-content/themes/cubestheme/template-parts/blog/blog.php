    ...
    <div class="container">
        <div class="blog-categories text-center animation" data-animation="slideUp" data-delay="0.08s">
            <div class="categories-tab-nav border pill-tabs">
                <a href="<?php echo esc_url($blog_page_url); ?>" class="categories-tab is-active">
                ...
                <?php if ($blog_categories) : ?>
                    <?php foreach ($blog_categories as $category) : ?>
                        ...
                        ?>
                        <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>" class="categories-tab">
        ...
        <?php
        $pagination_base = trailingslashit($blog_page_url) . user_trailingslashit('page/%#%/', 'paged');
        ?>
